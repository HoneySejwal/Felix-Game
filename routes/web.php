...
// Cart section
    ...
    Route::post('/points-add-to-cart', [CartController::class, 'pointsAddToCart'])->name('points-add-to-cart');
    Route::get('cart-delete/{id}', [CartController::class, 'cartDelete'])->name('cart-delete');
    Route::post('cart-update', [CartController::class, 'cartUpdate'])->name('cart.update');
    Route::get('trainingdelete/{id}', [CartController::class, 'trainingdelete'])->name('trainingdelete');
    Route::get('pointsredeem', [CartController::class, 'pointsredeem'])->name('buygame');
    ...
    Route::view('gamecart','frontend.pages.gamecart')->name('gamecart')->middleware('user');
